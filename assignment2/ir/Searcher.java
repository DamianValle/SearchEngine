...
public class Searcher {
    ...
    public PostingsList search( Query query, QueryType queryType, RankingType rankingType ) { 
    	...
    	*/
    	...
    	if( queryType == QueryType.INTERSECTION_QUERY ) {
    		...
    		return RankedSearch.search(query, index, rankingType, normType);
    ...
    // coger primera postingsList
    // computar scores para cada postingsEntry
    // coger segunda postingsList
    // computar scores para cada
    // hacer union sumando scores
    
    private PostingsList getRanked(ArrayList<PostingsList> postingsLists) {
    ...
    private PostingsList postingsUnion(PostingsList p1, PostingsList p2) {
